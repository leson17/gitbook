...
对着这张图先发呆30秒~  
![image](img/2547366513-5c452d63f3ade_fix732.png?w=634&h=522 "image")

### 什么是浏览器缓存

![image](img/3962242691-5c452d6477c53_fix732.png?w=449&h=327 "image")
...
![image](img/1105476498-5c452d629e740_fix732.png?w=109&h=25 "image") 
按钮不要打钩。**
...
```
ok。第一次请求.  
![image](img/1460000017962424.png?w=1020&h=630 "image")  
我们发现返回值里面已经有了Etag值。
